...
install -m644 ../patches/PSP.cmake $TOOLCHAIN_SCRIPT_PATH || { exit $(false); }
## copy CreatePBP.cmake
install -m644 ../patches/CreatePBP.cmake $TOOLCHAIN_SCRIPT_PATH || { exit $(false); }
## copy psp-cmake
install -d $PSP_CMAKE_PATH
install -m755 ../patches/psp-cmake $PSP_CMAKE_PATH || { exit $(false); }
